...
<body>
<div class="p-3">
    <h2 class="text-center fw-bold">Danh Sách Hộ Khẩu</h2>
    ...
    <nav class="navbar navbar-expand-lg py-0 my-0">
        <div class="container-fluid">
            <a href="/hokhau?action=create">
                <button class="btn btn-success btn-outline-secondary btn-sm">
                    <span class="fa-solid fa-person-circle-plus text-light h5 my-auto me-1"></span>
                    <span class="text-light"> Thêm Hộ Khẩu</span>
                </button>
            </a>

            <form class="d-flex my-2" role="search" action="/hokhau">
    ...
    <table id="hokhauTable" class="table table-light table-striped table-bordered">
        <thead>
        ...
        <tbody>
        <c:forEach varStatus="status" var="hokhau" items="${hoKhauList}">
            <tr>
                <td class="text-center">${status.count}</td>
                <td>${hokhau.hokhauId}</td>
                <td>${hokhau.hokhauName}</td>
                <td>${hokhau.hokhauSoluong}</td>
                <td>${hokhau.hokhauNgayNhap}</td>
                <td>${hokhau.hokhauDiaChi}</td>
                <td class="text-center">
                    <a href="/hokhau?action=edit&hokhauId=${hokhau.hokhauId}">
                ...
                <td class="text-center">
                    <a data-bs-toggle="modal"
                       ...
                       onclick="deleteHoKhau('${hokhau.getHokhauId()}','${hokhau.getHokhauName()}')">
