...
<div class="mx-5 px-5 pt-3">
    <h2 class="text-center fw-bold">Chỉnh Sửa Hộ Khẩu</h2>
    ...
    <div class="d-flex justify-content-center">
        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" method="post">
            <div class="mt-3 form-group">
                <label for="id" class="h6">Mã Hộ Khẩu</label>
                <div class="input-group">
                    <input type="text" id="id" class="form-control" name="hokhauId"
                           value="${hoKhau.hokhauId}">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="name" class="form-control" name="hokhauName" value="${hoKhau.hokhauName}"
            ...
            <div class="mt-3 form-group">
                <label for="idCard" class="h6">Số Lượng Thành Viên</label>
                <div class="input-group">
                    <input type="text" id="idCard" class="form-control" name="hokhauSoluong"
                           value="${hoKhau.hokhauSoluong}">
                    <span class="input-group-text"><i class="fa-solid fa-id-card"></i></span>
                </div>
            </div>

            <div class="mt-3 form-group">
                <label for="dateOfBirth" class="h6">Ngày Lập Hộ Khẩu</label>
                <input type="date" id="dateOfBirth" class="form-control" name="hokhauNgayNhap"
                       value="${hoKhau.hokhauNgayNhap}">
            </div>

            <div class="mt-3 form-group">
                <label for="address" class="h6">Địa Chỉ Nhà</label>
                <div class="input-group">
                    <input type="text" id="address" class="form-control" name="hokhauDiaChi"
                           value="${hoKhau.hokhauDiaChi}" required pattern="^.+$"
